...
export default function ContactsUI() {
  ...
  return (
    <>
      <div id="contacts" className="text-transparent bg-white" >
        contatti
      </div>
      <div className="flex flex-col items-center pt-14 bg-white">
        {/* titolo */}
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              <div className="flex-1 flex flex-col">
                ...
                <input
                  ...
                  required
                />
                <label className="mt-5 pb-2">E-mail</label>
                <input
                  type="email"
                  name="user_email"
                  className="border border-gray-800 rounded-lg p-2 bg-[rgb(235,240,243)]"
              ...
              <div className="flex-1 flex flex-col" >
                <label className="pb-2">Messaggio</label>
                <textarea
                  name="message"
